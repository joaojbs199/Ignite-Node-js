...
import { FetchQuestionAnswersUserCase } from './fetch-question-answers';
...
let sut: FetchQuestionAnswersUserCase;
...
describe('List answers answers', () => {
  beforeEach(() => {
    ...
    sut = new FetchQuestionAnswersUserCase(inMemoryAnswerRepository);
  });
